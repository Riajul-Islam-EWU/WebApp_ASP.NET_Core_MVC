...
namespace WebApp_ASP.NET_Core_MVC.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderItemID,OrderId,ProductId,OrderQuantity")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderItemID,OrderId,ProductId,OrderQuantity")] OrderItem orderItem)
        {
